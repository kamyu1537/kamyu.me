    ...
    <Card>
      <div className="w-32 h-32 bg-gray-300 overflow-hidden rounded-full mb-3 mx-auto">
        <img
          ...
          alt=""
          title="gravatar"
          src="https://www.gravatar.com/avatar/5b3ec40d9f3d438f67d71da1b3a6eb6b.png?size=128"
        />
      </div>
      ...
      <div className="text-sm mt-4 text-slate-600">
        ...
        <p className="text-xs text-slate-400 dark:text-slate-600">
          html, css, javascript, typescript, c#, java, kotlin, go, rust etc.
        </p>
      </div>

      <div className="flex gap-3 justify-center mt-7 pt-3 border-t text-slate-800 dark:text-slate-300">
        <a href="https://github.com/kamyu1537" target="_blank" rel="noreferrer">
          <AiFillGithub />
        </a>
        <a href="https://gitlab.com/kamyu" target="_blank" rel="noreferrer">
          <AiFillGitlab />
        </a>
        <a href="https://npmjs.org/~kamyu" target="_blank" rel="noreferrer">
          <ImNpm />
        </a>
        <a href="https://twitter.com/kamyu1537" target="_blank" rel="noreferrer">
          <ImTwitter />
        </a>
      </div>
    </Card>
